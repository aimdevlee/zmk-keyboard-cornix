...
U_MT(LCTRL, Q),    U_MT(LALT, S),     U_MT(LGUI, D),    U_MT_SHIFT(LSHFT, F),    &kp G,             &kp H,             U_MT_SHIFT(LSHFT, J),    U_MT(LGUI, K),      U_MT(LALT, L),     U_MT(LCTRL, M),     \
...
U_MT(LCTRL, Y),    U_MT(LALT, I),     U_MT(LGUI, E),    U_MT_SHIFT(LSHFT, A),    &kp DOT,           &kp D,             U_MT_SHIFT(LSHFT, S),    U_MT(LGUI, T),      U_MT(LALT, N),     U_MT(LCTRL, B),     \
...
U_MT(LCTRL, A),    U_MT(LALT, R),     U_MT(LGUI, S),    U_MT_SHIFT(LSHFT, T),    &kp D,             &kp H,             U_MT_SHIFT(LSHFT, N),    U_MT(LGUI, E),      U_MT(LALT, I),     U_MT(LCTRL, O),     \
...
U_MT(LCTRL, A),    U_MT(LALT, R),     U_MT(LGUI, S),    U_MT_SHIFT(LSHFT, T),    &kp G,             &kp M,             U_MT_SHIFT(LSHFT, N),    U_MT(LGUI, E),      U_MT(LALT, I),     U_MT(LCTRL, O),     \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LCTRL, A),    U_MT(LALT, R),     U_MT(LGUI, S),    U_MT_SHIFT(LSHFT, T),    &kp G,             &kp K,             U_MT_SHIFT(LSHFT, N),    U_MT(LGUI, E),      U_MT(LALT, I),     U_MT(LCTRL, O),     \
...
U_MT(LCTRL, A),    U_MT(LALT, O),     U_MT(LGUI, E),    U_MT_SHIFT(LSHFT, U),    &kp I,             &kp D,             U_MT_SHIFT(LSHFT, H),    U_MT(LGUI, T),      U_MT(LALT, N),     U_MT(LCTRL, S),     \
...
U_MT(LCTRL, S),    U_MT(LALT, H),     U_MT(LGUI, N),    U_MT_SHIFT(LSHFT, T),    &kp COMMA,         &kp DOT,           U_MT_SHIFT(LSHFT, A),    U_MT(LGUI, E),      U_MT(LALT, O),     U_MT(LCTRL, I),     \
...
U_MT(LCTRL, A),    U_MT(LALT, S),     U_MT(LGUI, H),    U_MT_SHIFT(LSHFT, T),    &kp G,             &kp Y,             U_MT_SHIFT(LSHFT, N),    U_MT(LGUI, E),      U_MT(LALT, O),     U_MT(LCTRL, I),     \
...
U_MT(LCTRL, A),    U_MT(LALT, S),     U_MT(LGUI, D),    U_MT_SHIFT(LSHFT, F),    &kp G,             &kp H,             U_MT_SHIFT(LSHFT, J),    U_MT(LGUI, K),      U_MT(LALT, L),     U_MT(LCTRL, SQT),   \
...
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_HML(LCTRL, A),   U_HML(LALT, R),    U_HML(LGUI, S),   U_HML_SHIFT(LSHFT, T),   &kp G,             &kp M,             U_HMR_SHIFT(LSHFT, N),   U_HMR(LGUI, E),     U_HMR(LALT, I),    U_HMR(LCTRL, O),    \
...
U_RGB_HUI,         U_RGB_SAI,         U_VOL_UP    ,      U_RGB_BRI,         U_RGB_TOG,         U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
U_RGB_EFF,         &kp C_PREV,        U_VOL_DN    ,      &kp C_NEXT,        U_EP_TOG,          U_NA,              &kp LSHFT,         &kp LGUI,         &kp LALT,          &kp LCTRL,          \
...
&kp C_PREV,        U_VOL_DN    ,      U_VOL_UP    ,      &kp C_NEXT,        U_EP_TOG,          U_NA,              &kp LSHFT,         &kp LGUI,         &kp LALT,          &kp LCTRL,          \
&u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,        U_NA,              &u_to_U_MEDIA,     &u_to_U_FUN,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp C_MUTE,        &kp C_PP,          &kp C_STOP,        U_NA,              U_NA,              U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MEDIA_INVERTEDT \
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RGB_TOG,         U_RGB_EFF,         U_VOL_UP    ,      U_RGB_HUI,         U_RGB_SAI,         \
&kp LCTRL,          &kp LALT,          &kp LGUI,         &kp LSHFT,         U_NA,              U_EP_TOG,          &kp C_PREV,        U_VOL_DN    ,      &kp C_NEXT,        U_RGB_BRI,         \
...
&kp LCTRL,          &kp LALT,          &kp LGUI,         &kp LSHFT,         U_NA,              &kp C_PREV,        U_VOL_DN    ,      U_VOL_UP    ,      &kp C_NEXT,        U_EP_TOG,          \
...
&kp LCTRL,          &kp LALT,          &kp LGUI,         &kp LSHFT,         U_NA,              U_EP_TOG,          &kp C_PREV,        U_VOL_DN    ,      U_VOL_UP    ,      &kp C_NEXT,        \
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              &u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp C_STOP,        &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP
